...
static const int64 MAX_MONEY = 21000000 * COIN; // YounetCoin: maximum of N coins (given some randomness), max transaction 10,000,000,000 for now
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 2 * COIN * (60 * 24 / 10) / 250; // YounetCoin: Priority cutoff is 2 YounetCoin day / 250 bytes.
    }
